...
const About = () => (
  <section className={`${styles.paddings} relative z-10 `}>
    ...
    >
      <TypingText title="| About Metaverse" textStles="text-center" />
      <motion.p
      ...
      >
        ...
        reality. Let's{' '}
        <span className="font-extrabold text-white">explore</span> the madeness
        of metaverse by scrolling down
      </motion.p>
